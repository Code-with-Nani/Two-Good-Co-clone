...
const Footer = () => {
  return (
    <div className="w-screen   py-20 lg:px-7 px-3 relative">
      <div className="center hidden lg:block absolute  left-1/2 -translate-x-1/2 -top-5">
        <svg
          className=""
          width="200"
          height="200"
      ...
      <div className="center lg:hidden absolute  left-1/2 -translate-x-1/2 -top-7 ">
        <svg
          className=""
          width="100"
          height="100"
      ...
      <div className="flex justify-between">
        ...
        <div className="right list-none lg:pr-7">
          <li className="">Good Things FAQs</li>
          <li className="">Good Food FAQs</li>
          <li className="">Good Places</li>
          <li className="">Pathways</li>
          <li className="">Careers</li>
        </div>
      </div>
      <p className="text-center mt-3 lg:mt-20">© TWO GOOD CO. 2024</p>
    </div>
  );
};
